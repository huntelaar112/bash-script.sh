...
(( used > threshold )) && {
    log-step "Find the files created older than 90 days (Save to ${files})..."
    find  /mnt/containerdata/./*/saved_images/ /mnt/containerdata/./*/app_log/ -mtime +90 -type f > "${files}"
